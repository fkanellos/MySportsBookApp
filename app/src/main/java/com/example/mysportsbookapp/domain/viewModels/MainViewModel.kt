    ...
    fun setValuesForExpandableAdapter(value: List<SportsResponseItem>): List<SportsTitleViewModel> {
        ...
        value.forEach {
            ...
            it.e.forEach { child ->
                ...
                teamDetailsRow.firstTeam = Utils.splitStringAndReturn(child.gameInfo, 2, Regex("-"), 0)
                teamDetailsRow.secondTeam = Utils.splitStringAndReturn(child.gameInfo, 2, Regex("-"), 1)
